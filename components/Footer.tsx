  ...
  return (
    <footer style={{
      ...
      <div style={{ maxWidth: 1080, margin: '0 auto' }}>
        ...
        <p className="sans" style={{ fontSize: 12, color: 'rgba(250,248,245,0.45)', marginBottom: 20 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 16, marginBottom: 20, flexWrap: 'wrap' }}>
          <a
            href="https://www.instagram.com/jogpro_"
            target="_blank" rel="noopener noreferrer"
            style={{ display: 'flex', alignItems: 'center', gap: 6, color: 'rgba(250,248,245,0.6)', textDecoration: 'none', fontSize: 13, transition: 'color 0.2s' }}
          ...
          <a
            href="https://www.tiktok.com/@joko_tresna"
            target="_blank" rel="noopener noreferrer"
            style={{ display: 'flex', alignItems: 'center', gap: 6, color: 'rgba(250,248,245,0.6)', textDecoration: 'none', fontSize: 13, transition: 'color 0.2s' }}
            onMouseEnter={e => (e.currentTarget.style.color = '#FAF8F5')}
            onMouseLeave={e => (e.currentTarget.style.color = 'rgba(250,248,245,0.6)')}
          ...
          <a
            href="https://www.facebook.com/profile.php?id=61574792985124"
            target="_blank" rel="noopener noreferrer"
            style={{ display: 'flex', alignItems: 'center', gap: 6, color: 'rgba(250,248,245,0.6)', textDecoration: 'none', fontSize: 13, transition: 'color 0.2s' }}
            onMouseEnter={e => (e.currentTarget.style.color = '#FAF8F5')}
            onMouseLeave={e => (e.currentTarget.style.color = 'rgba(250,248,245,0.6)')}
